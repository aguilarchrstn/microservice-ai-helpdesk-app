...
console.log("IT Helpdesk widget build: 2026-07-23-v6 (sidebar: new chat + coming-soon toast)");
...
export default function HelpdeskApp() {
  ...
  function showComingSoon(label) {
    ...
    setTimeout(() => setToast((cur) => (cur === `${label} — coming soon` ? null : cur)), 2200);
  }
  ...
  return (
    <div className="app">
      <aside className="sidebar">
        <button className="sidebar__logo" onClick={handleNewChat} aria-label="New chat">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
            <path d="M7 17L17 7M17 7H9M17 7V15" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </button>
        <nav className="sidebar__nav">
          <button className={`sidebar__icon ${!started ? "sidebar__icon--active" : ""}`} onClick={handleNewChat} aria-label="New chat">
            <Home size={18} />
          </button>
          <button className="sidebar__icon" onClick={() => showComingSoon("Tickets")} aria-label="Tickets">
            <Inbox size={18} />
          </button>
          <button className="sidebar__icon" onClick={() => showComingSoon("Notifications")} aria-label="Notifications">
            <Mail size={18} />
          </button>
          <button className="sidebar__icon" onClick={() => showComingSoon("Knowledge base")} aria-label="Knowledge base">
            <Table2 size={18} />
          </button>
        </nav>
        <div className="sidebar__bottom">
          <button className="sidebar__icon" onClick={() => showComingSoon("Settings")} aria-label="Settings">
            <Settings size={18} />
          </button>
          <button className="sidebar__icon" onClick={() => showComingSoon("More")} aria-label="More">
